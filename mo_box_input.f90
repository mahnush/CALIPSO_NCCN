...
CONTAINS
  ...
  IMPLICIT NONE
    ...
    CHARACTER(len=150), INTENT(out)	:: ofilename1, ofilename2, ofilename3, ofilename4
    ...
    IF (fileexists) then
      ...
      READ(10,'(A)') ofilename4  ! read output filename to know which file to create
      !WRITE(*,*) 'ofilename4:', ofilename4    
      ...
      READ(10,'(A)') day  ! read output filename to know which file to create
      !WRITE(*,*) 'day:', day 
